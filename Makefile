...
test:
	PYTHONPYCACHEPREFIX=$(PYCACHE_PREFIX) $(PYTHON) -m unittest tests.test_palamedes_opportunity tests.test_palamedes_architecture_transfer tests.test_palamedes_cognition_v3 tests.test_palamedes_evidence_bundle tests.test_palamedes_product_cognition_acceptance
...
compile:
	PYTHONPYCACHEPREFIX=$(PYCACHE_PREFIX) $(PYTHON) -m py_compile palamedes_opportunity.py palamedes_architecture_transfer.py palamedes_cognition_v3.py palamedes_evidence_bundle.py tests/test_palamedes_opportunity.py tests/test_palamedes_architecture_transfer.py tests/test_palamedes_cognition_v3.py tests/test_palamedes_evidence_bundle.py tests/test_palamedes_product_cognition_acceptance.py
