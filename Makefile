...
test:
	PYTHONPYCACHEPREFIX=$(PYCACHE_PREFIX) $(PYTHON) -m unittest tests.test_palamedes tests.test_palamedes_chat tests.test_palamedes_observe tests.test_palamedes_server tests.test_palamedes_client tests.test_contracts tests.test_ref_library tests.test_palamedes_mission
...
compile:
	PYTHONPYCACHEPREFIX=$(PYCACHE_PREFIX) $(PYTHON) -m py_compile palamedes.py palamedes_store.py palamedes_agent.py palamedes_chat.py palamedes_observe.py palamedes_server.py palamedes_client.py palamedes_mission.py palamedes_sdk/__init__.py palamedes_sdk/client.py scripts/ref_library.py scripts/materialize_reasoning_cycles.py examples/palamedes_kernel_adapter.py examples/palamedes_planner_host.py tests/test_palamedes.py tests/test_palamedes_chat.py tests/test_palamedes_observe.py tests/test_palamedes_server.py tests/test_palamedes_client.py tests/test_contracts.py tests/test_ref_library.py tests/test_palamedes_mission.py
